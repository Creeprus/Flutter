...
class MeditateSunAndMoon extends StatefulWidget {
  const MeditateSunAndMoon({Key? key}) : super(key: key);

  @override
  State<MeditateSunAndMoon> createState() => _ScreenState();
}

class _ScreenState extends State<MeditateSunAndMoon> {
  @override
