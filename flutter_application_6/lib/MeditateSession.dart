...
class MeditateSession extends StatefulWidget {
  const MeditateSession({Key? key}) : super(key: key);

  @override
  State<MeditateSession> createState() => _ScreenState();
}

class _ScreenState extends State<MeditateSession> {
  @override
